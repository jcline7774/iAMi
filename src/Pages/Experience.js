      ...
      <div className='mob-exp '>
        <div className='exp-top df '>
          <div className='left-exp ' >
            <Card2 pno='01'
             details={<div className='ex-c-details text-slate-800 dark:text-gray-100'>
        ...
        <div className='exp-bottom df ' >
          <div className='exp-bottom-left df text-slate-800 dark:text-gray-100 bg-slate-400 dark:bg-gray-900' >
            ...
            <BodyCard header={'Frontend'} skills={[
               ...
               { name: 'Typescript', level: '87%', color: '#61dafb'},
               { name: 'HTML/CSS', level: '99%', color: '#68a063' },
               { name: 'Mongoose', level: '91%', color: '#61dafb' },
               { name: 'jQuery/CSS', level: '90%', color: '#68a063' }]}/>
            <BodyCard header={'Backend'} skills={[
              { name: 'Python3', level: '90%', color: '#61dafb' },
              ...
              { name: 'JSON', level: '97%', color: '#61dafb' },
              { name: 'Java(basic)', level: '80%', color: '#68a063' },
            ...
            <BodyCard header={'DevOps'} skills={[
              ...
              { name: 'Lambda', level: '83%', color: '#68a063' },
